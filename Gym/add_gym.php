...
<div class="w3-container">
	<form class="form-group mt-3" method="post" action="">
		<div><h3>AÑADIR GIMNASIO</h3></div>
		 <?php include('errors.php'); 
    echo @$msg;

    ?>
		<label class="mt-3">ID GIMNASIO</label>
		<input type="text" name="id" class="form-control">
		<label class="mt-3">NOMBRE DEL GIMNASIO</label>
		<input type="text" name="name" class="form-control">
		<label class="mt-3">DIRECCION DEL GIMNASIO</label>
		<input type="text" name="address" class="form-control">
		<label class="mt-3">TIPO GIMNASIO</label>
		<select name="type" class="form-control mt-3">
    <option value="unisex">UNISEX</option>
    <option value="women">MUJER</option>
    <option value="men">HOMBRE</option>  
    </select>
		<button class="btn btn-dark mt-3" type="submit" name="gym">AÑADIR</button>
	</form>
</div>