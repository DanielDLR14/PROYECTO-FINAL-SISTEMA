...
<html>
<head>
	<title>Gym Perfect Sistema de Gestion</title>
	<meta charset="utf-8">
...
<body style="background:url(gym_bg.jpg);">
  ...
  <a class="navbar-brand" href="home.php">Gym Perfect Sistema de Gestion</a>
  ...
  <div class="col-2">
    ...
    <div class="list-group">
      <div class="list-group-item bg-dark">
        ...
        <i class="fas fa-user-alt"></i>  GIMNASIO</a>
      </div>
      <div id="collapseTwo" class="collapse" data-parent="#accordion">
          <div class="list-group-item" style="background-color: #303030;"><a href="home.php?info=add_gym" class="text-light">AÑADIR GIMNASIO</a>
          </div>
          <div class="list-group-item" style="background-color: #303030;"><a href="home.php?info=manage_gym" class="text-light">VER GIMNASIOS</a></div>
        </div>
      <div class="list-group-item bg-dark">
        <a class="collapsed nav-link text-light" data-toggle="collapse" href="#collapseThree">
          <i class="fas fa-user-graduate"></i> DEPT DE PAGO</a>
      </div>
      ...
      <div id="collapsefive" class="collapse" data-parent="#accordion">
          <div class="list-group-item" style="background-color: #303030;"><a href="home.php?info=add_member" class="text-light">AÑADIR MIEMBROS</a></div>
        ...
        <i class="fas fa-users"></i>ENTRENADORES
      </a>
      </div>
      <div id="collapsesix" class="collapse" data-parent="#accordion">
          <div class="list-group-item" style="background-color: #303030;"><a href="home.php?info=add_trainer" class="text-light">AÑADIR ENTRENADOR</a></div>
