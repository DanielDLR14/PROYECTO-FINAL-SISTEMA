...
<div class="container">
    ...
    ?>
		...
		<label class="mt-3">FECHA NACIMIENTO </label></label>
		<input type="text" name="dob" class="form-control">
		<label class="mt-3">NUMERO TELEFONO</label>
		<input type="text" name="mobileno" class="form-control">
    <label class="mt-3">FECHA PAGO REALIZADO</label>
		<input type="text" name="pay_id" class="form-control">
    <label class="mt-3">FECHA PROXIMO PAGO</label>
		<input type="text" name="pay_id" class="form-control">
		<label class="mt-3">ID AREA PAGO</label>
		<input type="text" name="pay_id" class="form-control">
		<label class="mt-3">ID ENTRENADOR</label>
