...
<div class="container">
	<form class="form-group mt-3" method="post" action="">
		<div><h3>AÑADIR CLIENTE</h3></div>
		 <?php include('errors.php'); 
    echo @$msg;

    ?>
		<label class="mt-3">ID CLIENTE</label>
		<input type="text" name="id" class="form-control">
		<label class="mt-3">NOMBRE DEL CLIENTE</label>
		<input type="text" name="name" class="form-control">
		<label class="mt-3">EDAD DEL CLIENTE</label>
		<input type="text" name="age" class="form-control">
		<label class="mt-3">CEDULA DEL CLIENTE</label>
		<input type="text" name="dob" class="form-control">
		<label class="mt-3">FECHA INSCRIPCION</label>
		<input type="text" name="package" class="form-control">
		<label class="mt-3">NUMERO DE TELFONO</label>
		<input type="text" name="mobileno" class="form-control">
		<label class="mt-3">ID AREA DE PAGO</label>
		<input type="text" name="pay_id" class="form-control">
		<label class="mt-3">ID DEL ENTRENADOR</label>
		<input type="text" name="trainer_id" class="form-control">
		<button class="btn btn-dark mt-3" type="submit" name="member">AÑADIR</button>
	</form>
</div>